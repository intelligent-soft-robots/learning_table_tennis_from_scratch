...
def _reward(min_distance_ball_racket,
            min_distance_ball_target,
            max_ball_velocity,
            c,
            rtt_cap):
    return _compute_reward(False,
                           min_distance_ball_racket,
                           min_distance_ball_target,
                           max_ball_velocity,
                           c,
...
def _smash_reward(min_distance_ball_racket,
                  min_distance_ball_target,
                  max_ball_velocity,
                  c,
                  rtt_cap):
    return _compute_reward(True,
                           min_distance_ball_racket,
                           min_distance_ball_target,
                           max_ball_velocity,
                           c,
...
class Reward:
    ...
    def __call__(self,
                 ...
                 min_distance_ball_target,
                 max_ball_velocity):
        return _reward(min_distance_ball_racket,
                       min_distance_ball_target,
                       max_ball_velocity,
...
class SmashReward:
    ...
    def __call__(self,
                 ...
                 min_distance_ball_target,
                 max_ball_velocity):
        return _smash_reward(min_distance_ball_racket,
                             min_distance_ball_target,
                             max_ball_velocity,
                             self.config.normalization_constant,
                             self.config.rtt_cap)
