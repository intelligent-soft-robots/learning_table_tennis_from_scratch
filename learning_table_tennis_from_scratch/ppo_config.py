...
class PPOConfig:
    ...
    __slots__= ("gamma","n_steps","ent_coef",
...
class OpenAIPPOConfig:
    __slots__= ("gamma","num_timesteps","ent_coef",
                "lr","cliprange",
                "vf_coef","max_grad_norm","lam",
                "nminibatches","noptepochs",
                 "network", "num_layers", "num_hidden",
                 "activation", "nsteps")  #, "seed")
    def __init__(self):
        for s in self.__slots__:
            setattr(self,s,None)
    def get(self):
    ...
    @staticmethod
    def default_path():
        return os.path.join("/home/sguist/Workspaces_local/isr/learning_table_tennis_from_scratch/config",
